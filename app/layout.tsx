...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={cn("antialiased bg-background text-foreground font-sans")}
      >
        <ReactQueryClientProvider>
          ...
          >
            <main className="h-screen overflow-auto">
              <header className="z-20 sticky top-0 h-14 border-b dark:shadow border-border px-4 flex justify-between items-center bg-background">
                <Link href="/" className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-2xl font-semibold leading-none hidden sm:block">
                    Ollama Next
                  </span>
                </Link>
